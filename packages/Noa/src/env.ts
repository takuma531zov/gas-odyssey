...
export const SCRIPT_PROPERTIES = {
  ...
  FREE_CONVERT_API_KEY: "FREE_CONVERT_API_KEY",
  ...
  OPEN_AI_MODEL_PROD: "OPEN_AI_MODEL_PROD",
  FREE_CONVERT_API_KEY_PROD: "FREE_CONVERT_API_KEY_PROD",
} as const;
...
export const FREE_CONVERT_API_KEY = getScriptPropertyValue(
  isDev
    ? SCRIPT_PROPERTIES.FREE_CONVERT_API_KEY
    : SCRIPT_PROPERTIES.FREE_CONVERT_API_KEY_PROD,
);
