...
export const HIGH_CONFIDENCE_PATTERNS: readonly string[] = ['/contact/', '/contact', '/inquiry/', '/inquiry'];

// 中信頼度パターン（NetworkUtilsから移動）  
export const MEDIUM_CONFIDENCE_PATTERNS: readonly string[] = ['/form/', '/form'];